...
export default function XtraLabHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#FF9933] text-white py-4 px-4 shadow-[0px_5px_5px_rgba(255,255,255,0.5)] font-[Geneva, Verdana, Tahoma, system-ui, sans-serif] ">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-6">
          ...
          <Link href="/rent" className="font-bold hover:text-black">
            Rent
          </Link>
        </nav>
